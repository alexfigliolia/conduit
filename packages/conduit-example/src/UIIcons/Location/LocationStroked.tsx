...
export const LocationStroked = memo(
  ({ className, children, ...rest }: SVGProps<SVGSVGElement>) => {
    const classes = useClassNames("location-icon-stroked", className);
    return (
      <svg viewBox="-4 0 32 32" version="1.1" className={classes} {...rest}>
